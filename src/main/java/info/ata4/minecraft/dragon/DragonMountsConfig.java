...
public class DragonMountsConfig {
    ...
    public static void LoadDragonMountsConfig(Configuration config) {
        ...
        juvenileToAdultTime = config.getInt("juvenileToAdultTime", categoryGrowth, juvenileToAdultTime, 4800, Integer.MAX_VALUE, "How many ticks juveniles takes to turn into adults.\nThere are 20 ticks in a second and 24000 in a Miecraft day.");
